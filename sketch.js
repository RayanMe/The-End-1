...
function preload(){
  ...
  //Animations and images being loaded
...
function setup() {
  ...
  //Canvas and sprites being setup with their respective properties
  ...
  //Score is being asssigned a value
...
function draw() {
  ...
  //Camera will be centered to tres x and y
